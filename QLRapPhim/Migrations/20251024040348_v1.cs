    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoAns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoaiPhims", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatViewModels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Phims_LoaiPhims_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GheNgois", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GheNgois_PhongChieus_ScreenId",
                        column: x => x.ScreenId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SuatChieus_Phims_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Phims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuatChieus_PhongChieus_ScreenId",
                        column: x => x.ScreenId,
                        principalTable: "PhongChieus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_DoAns_FoodId",
                        column: x => x.FoodId,
                        principalTable: "DoAns",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_SuatChieus_ShowtimeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingDetails_Bookings_BookingId1",
                        column: x => x.BookingId1,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingDetails_GiaVes_TicketPriceId",
                        column: x => x.TicketPriceId,
                        principalTable: "GiaVes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDetails_BookingId1",
                table: "BookingDetails",
                column: "BookingId1");

            migrationBuilder.CreateIndex(
                name: "IX_BookingDetails_TicketPriceId",
                table: "BookingDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GheNgois_ScreenId",
                table: "GheNgois",
                column: "ScreenId");

            migrationBuilder.CreateIndex(
                name: "IX_Phims_CategoryId",
                table: "Phims",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SuatChieus_MovieId",
                table: "SuatChieus",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_SuatChieus_ScreenId",
                table: "SuatChieus",
                column: "ScreenId");
        }
